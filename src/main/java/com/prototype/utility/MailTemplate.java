...
public class MailTemplate {
	static String template = "" + "<!doctype html> " + "<html> " + "  <head> "
			...
			+ "    margin-bottom: 10px !important; " + "  } " + " " + "  table.body p, " + "table.body ul, "
			+ "table.body ol, " + "table.body td, " + "table.body span, " + "table.body a "
			+ "{    font-size: 16px !important; " + "  } " + " " + "  table.body .wrapper, " + "table.body .article "
			+ "{    padding: 10px !important; " + "  } " + " " + "  table.body .content "
			+ "{    padding: 0 !important; " + "  } " + " " + "  table.body .container "
			...
			+ "  } " + " " + "  table.body .img-responsive " + "{    height: auto !important; "
			+ "    max-width: 100% !important; " + "    width: auto !important; " + "  } " + "} " + "@media all "
			...
			+ "{    line-height: 100%; " + "  } " + " " + "  .apple-link a " + "{    color: inherit !important; "
			+ "    font-family: inherit !important; " + "    font-size: inherit !important; "
			+ "    font-weight: inherit !important; " + "    line-height: inherit !important; "
			+ "    text-decoration: none !important; " + "  } " + " " + "  #MessageViewBody a "
